...
![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/32f723ediscovery.svg?color=brightgreen)
...
This **32f723ediscovery** MCU component repository is one element of the **STM32CubeF7** MCU embedded software package, providing the **32F723EDISCOVERY** BSP BOARD component part.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/32f723ediscovery/blob/main/Release_Notes.html).
